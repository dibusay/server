  ...
  it('should delete favourite on /favourites/:id DELETE', function(done) {
    ...
    chai.request(server)
      ...
      .end(function(err, res) {
        ...
        res.should.be.a('object')
        res.body.should.have.property('msg')
        res.body.should.have.property('updatedData')
        res.body.updatedData.should.be.a('object')
        res.body.updatedData.should.have.property('userName')
        res.body.updatedData.should.have.property('favourites')
        done()
      })
  })
